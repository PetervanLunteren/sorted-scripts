# Script to copy files from the main databse to a training folder for training a yolov8 classifier
...
# define dictionary for which data belongs to which class -> class_name : [path_to_dir1, path_to_dir2]
class_dict = {'Panthera_leo' : [r'C:\Users\smart\Desktop\dummy_DB\lion'],
              'Unknown_animal' : [r'C:\Users\smart\Desktop\dummy_DB\non-lion']}

# define the destination folder where you want to collect all the copies of training images.
training_folder = r'C:\Users\smart\Desktop\crops-trainset'
